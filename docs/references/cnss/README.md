...
CNSS, Direction des affiliés — *Cahier des Charges relatif à la réalisation des déclarations des salaires en Mode Echange de Fichiers entre la CNSS et ses Affiliés*, **version 2**, février 2006, 36 pages. Publié sur cnss.ma sous le nom de fichier `cahier de chargev1Damancom.pdf` (le nom indique v1, le contenu est v2).
...
| **ANO-005** | **Nom de fichier MMAAAA vs `L_Période` AAAAMM — *non tranché*** |
...
| **ANO-013** | **E04 `N_Num_Affilie` espaces vs erreur 242 — *non tranché*** |
